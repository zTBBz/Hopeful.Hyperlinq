...
class Program
{
    ...
    static void SaveSummary(Summary summary)
    {
        ...
        logger.WriteLine($"[{title}.cs](../Hopeful.Hyperlinq.Benchmarks/Benchmarks/{title}.cs)");
        logger.WriteLine();
        ...
        logger.WriteLine($"- Hopeful.Hyperlinq: [{hyperlinqVersion}](https://www.nuget.org/packages/Hopeful.Hyperlinq/{hyperlinqVersion})");
