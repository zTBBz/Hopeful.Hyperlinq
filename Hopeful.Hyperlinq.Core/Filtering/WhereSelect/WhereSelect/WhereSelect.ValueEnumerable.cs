...
#pragma warning restore IDE0044 // Add readonly modifier
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public SelectManyEnumerable<WhereSelectEnumerable<TEnumerable, TEnumerator, TSource, TResult, TPredicate, TSelector>, Enumerator, TResult, TSubEnumerable, TSubEnumerator, TResult2, TSelector2> SelectMany<TSubEnumerable, TSubEnumerator, TResult2, TSelector2>(TSelector2 selector = default)
            ...
            => this.SelectMany<WhereSelectEnumerable<TEnumerable, TEnumerator, TSource, TResult, TPredicate, TSelector>, Enumerator, TResult, TSubEnumerable, TSubEnumerator, TResult2, TSelector2>(selector);
        ...
        public Lease<TResult> ToArray(ArrayPool<TResult> pool, bool clearOnDispose = default)
            => source.ToArray<TEnumerable, TEnumerator, TSource, TResult, TPredicate, TSelector>(pool, clearOnDispose, predicate, selector);
    ...
    public static int Sum<TEnumerable, TEnumerator, TSource, TPredicate, TSelector>(this WhereSelectEnumerable<TEnumerable, TEnumerator, TSource, int, TPredicate, TSelector> source)
        ...
        => source.source.Sum<TEnumerable, TEnumerator, TSource, int, int, TPredicate, TSelector>(source.predicate, source.selector);
    ...
    public static nint Sum<TEnumerable, TEnumerator, TSource, TPredicate, TSelector>(this WhereSelectEnumerable<TEnumerable, TEnumerator, TSource, nint, TPredicate, TSelector> source)
        ...
        => source.source.Sum<TEnumerable, TEnumerator, TSource, nint, nint, TPredicate, TSelector>(source.predicate, source.selector);
    ...
    public static nuint Sum<TEnumerable, TEnumerator, TSource, TPredicate, TSelector>(this WhereSelectEnumerable<TEnumerable, TEnumerator, TSource, nuint, TPredicate, TSelector> source)
        ...
        => source.source.Sum<TEnumerable, TEnumerator, TSource, nuint, nuint, TPredicate, TSelector>(source.predicate, source.selector);
    ...
    public static long Sum<TEnumerable, TEnumerator, TSource, TPredicate, TSelector>(this WhereSelectEnumerable<TEnumerable, TEnumerator, TSource, long, TPredicate, TSelector> source)
        ...
        => source.source.Sum<TEnumerable, TEnumerator, TSource, long, long, TPredicate, TSelector>(source.predicate, source.selector);
    ...
    public static float Sum<TEnumerable, TEnumerator, TSource, TPredicate, TSelector>(this WhereSelectEnumerable<TEnumerable, TEnumerator, TSource, float, TPredicate, TSelector> source)
        ...
        => source.source.Sum<TEnumerable, TEnumerator, TSource, float, float, TPredicate, TSelector>(source.predicate, source.selector);
    ...
    public static double Sum<TEnumerable, TEnumerator, TSource, TPredicate, TSelector>(this WhereSelectEnumerable<TEnumerable, TEnumerator, TSource, double, TPredicate, TSelector> source)
        ...
        => source.source.Sum<TEnumerable, TEnumerator, TSource, double, double, TPredicate, TSelector>(source.predicate, source.selector);
    ...
    public static decimal Sum<TEnumerable, TEnumerator, TSource, TPredicate, TSelector>(this WhereSelectEnumerable<TEnumerable, TEnumerator, TSource, decimal, TPredicate, TSelector> source)
        ...
        => source.source.Sum<TEnumerable, TEnumerator, TSource, decimal, decimal, TPredicate, TSelector>(source.predicate, source.selector);
