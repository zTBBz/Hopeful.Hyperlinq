...
static partial class GeneratedExtensionMethods
{
    ...
    public static GeneratedExtensionMethods.AsValueEnumerable_TestEnumerableWithValueTypeEnumerator_TestValueType_ AsEnumerable(this GeneratedExtensionMethods.AsValueEnumerable_TestEnumerableWithValueTypeEnumerator_TestValueType_ source)
        => Hopeful.Hyperlinq.ValueEnumerableExtensions.AsEnumerable<GeneratedExtensionMethods.AsValueEnumerable_TestEnumerableWithValueTypeEnumerator_TestValueType_, TestEnumerableWithValueTypeEnumerator<TestValueType>.Enumerator, TestValueType>(source);
}
