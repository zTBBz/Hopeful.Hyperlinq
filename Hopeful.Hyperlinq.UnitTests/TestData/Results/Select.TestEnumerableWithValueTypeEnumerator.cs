...
static partial class GeneratedExtensionMethods
{
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static ValueEnumerableExtensions.SelectEnumerable<GeneratedExtensionMethods.AsValueEnumerable_TestEnumerableWithValueTypeEnumerator_TestValueType_, TestEnumerableWithValueTypeEnumerator<TestValueType>.Enumerator, TestValueType, TestReferenceType, Hopeful.Hyperlinq.FunctionWrapper<TestValueType, TestReferenceType>> Select(this GeneratedExtensionMethods.AsValueEnumerable_TestEnumerableWithValueTypeEnumerator_TestValueType_ source, System.Func<TestValueType, TestReferenceType> selector)
        => Hopeful.Hyperlinq.ValueEnumerableExtensions.Select<GeneratedExtensionMethods.AsValueEnumerable_TestEnumerableWithValueTypeEnumerator_TestValueType_, TestEnumerableWithValueTypeEnumerator<TestValueType>.Enumerator, TestValueType, TestReferenceType, Hopeful.Hyperlinq.FunctionWrapper<TestValueType, TestReferenceType>>(source, selector);
}
